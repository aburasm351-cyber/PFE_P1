    ...
    <div className="w-full space-y-4" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      {isOnHold && (
        <motion.div
          ...
          className={cn(
            "flex items-center gap-3 bg-amber-50 border border-amber-200 text-amber-800 px-4 py-2 rounded-xl text-sm font-medium",
      ...
      {isCancelled && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className={cn(
            "flex items-center gap-3 bg-rose-50 border border-rose-200 text-rose-800 px-4 py-2 rounded-xl text-sm font-medium",
            isRtl && "flex-row-reverse text-right"
          )}
        >
              ...
              return (
                <div className={cn("flex items-center gap-3", isRtl && "flex-row-reverse")}>
                  ...
                  <div className={cn("space-y-0.5", isRtl && "text-right")}>
                    ...
                    <p className="text-base font-bold text-slate-900 dark:text-white leading-tight">{current.label}</p>
